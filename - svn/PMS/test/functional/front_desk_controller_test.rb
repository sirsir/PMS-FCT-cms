...
require 'front_desk_controller'

# Raise errors beyond the default web-based presentation
class FrontDeskController; def rescue_action(e) raise e end; end

class FrontDeskControllerTest < Test::Unit::TestCase
  ...
  def setup
    ...
    @controller = FrontDeskController.new
